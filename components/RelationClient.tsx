...
import { useRelationInitialPerson } from "./relation/useRelationInitialPerson";
...
export default function RelationClient() {
  ...
  // 初始人物：优先 ?id=（CBDB 权威 ID），否则回退 ?name= 并显式提示（拆入 useRelationInitialPerson）
  useRelationInitialPerson(a, setPathMsg);
