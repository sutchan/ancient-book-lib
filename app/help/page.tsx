  ...
  return (
    <section>
      ...
      <div className="card stat-panel" style={{ lineHeight: 1.95, fontSize: 15 }}>
        ...
        <p>A：该提示已基本消除——人物库（66 万 CBDB 人物，已含原人物考据的 28 位名人档案）、社会关系（亲属 56.1 万条 + 社会 19 万条）、生平任职（59.1 万条）、数据统计（含籍贯分布与官职-朝代联动）均已接入真实数据。双人溯源支持直接关系与 2-3 级中间关系，默认二级，三级探索较慢但覆盖更广。</p>
